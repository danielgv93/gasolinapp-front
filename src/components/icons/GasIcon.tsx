...
export const GasIcon = forwardRef<SVGSVGElement, {className?: string}>((props, ref) => {
    return (
            <svg ref={ref} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={`bi bi-fuel-pump ${props.className}`}
                 viewBox="0 0 16 16">
